...
interface InsuranceModelProps {
  isOpen: boolean;
  closeModal: () => void;
  modelType: string;
  setModelType: any;
  selectedInsuranceType: any;
  setSelectedInsuranceType: any;
}
...
export default function InsuranceModal({
  ...
  useEffect(() => {
    if (modelType === "edit" && selectedInsuranceType) {
      setFormData({
        name: selectedInsuranceType.name || "",
        description: selectedInsuranceType.description || "",
        status: selectedInsuranceType.status || "",
      });
    } else {
      setFormData({
        name: "",
  ...
  }, [selectedInsuranceType, modelType]);
  ...
  const getModalTitle = () => {
    switch (modelType) {
      case "add":
        return "Add New Insurance Type";
      case "edit":
        return "Update Insurance Type";
      case "delete":
        return "Delete Insurance Type";
      default:
        return "";
    }
  };
                  ...
                  <div className="flex items-center gap-3">
                    <div>
                      <p className="font-semibold text-gray-800 dark:text-gray-300">
                        {selectedInsuranceType?.name || "Insurance 56"}
                      </p>
                    </div>
                  </div>
                </div>
