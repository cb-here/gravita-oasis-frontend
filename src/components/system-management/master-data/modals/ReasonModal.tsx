...
export default function ReasonModal({
  ...
  useEffect(() => {
    if (modelType === "edit" && selectedReason) {
      setFormData({
  ...
  const getModalTitle = () => {
    switch (modelType) {
      case "add":
        return "Add New Hold Reason";
      case "edit":
        return "Update Hold Reason";
      case "delete":
        return "Delete Hold Reason";
      default:
        return "";
    }
  };
  ...
  const getModalDescription = () => {
    switch (modelType) {
      case "add":
        return "Add a new hold reason to the system";
      case "edit":
        return "Edit and manage hold reason information with ease.";
      case "delete":
        return `This action cannot be undone. It will permanently remove this hold reason.`;
      default:
        return "";
    }
  };
                  ...
                  <div className="flex items-center gap-3">
                    <div>
                      <p className="font-semibold text-gray-800 dark:text-gray-300">
                        {selectedReason?.name || "New Nurse Reason"}
                      </p>
                    </div>
                  </div>
                </div>
