...
export const metadata: Metadata = {
  title: "Gravity Oasis Tabs | TailAdmin - Gravity Oasis Dashboard Template",
  description:
    "This is Gravity Oasis Tabs page for TailAdmin - Gravity Oasis Tailwind CSS Admin Dashboard Template",
  // other metadata
};
