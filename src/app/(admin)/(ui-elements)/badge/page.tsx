...
export const metadata: Metadata = {
  title: "Gravity Oasis Badge | TailAdmin - Gravity Oasis Dashboard Template",
  description:
    "This is Gravity Oasis Badge page for TailAdmin - Gravity Oasis Tailwind CSS Admin Dashboard Template",
  // other metadata
};
