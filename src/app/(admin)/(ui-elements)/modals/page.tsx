...
export const metadata: Metadata = {
  title: "Gravity Oasis Modals | TailAdmin - Gravity Oasis Dashboard Template",
  description:
    "This is Gravity Oasis Modals page for TailAdmin - Gravity Oasis Tailwind CSS Admin Dashboard Template",
  // other metadata
};
