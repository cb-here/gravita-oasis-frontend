...
export const metadata: Metadata = {
  title: "Gravity Oasis Button Groups | TailAdmin - Gravity Oasis Dashboard Template",
  description:
    "This is Gravity Oasis Button Groups page for TailAdmin - Gravity Oasis Tailwind CSS Admin Dashboard Template",
};
