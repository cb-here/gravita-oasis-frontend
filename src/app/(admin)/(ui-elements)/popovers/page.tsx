...
export const metadata: Metadata = {
  title: "Gravity Oasis Popovers | TailAdmin - Gravity Oasis Dashboard Template",
  description:
    "This is Gravity Oasis Popovers page for TailAdmin - Gravity Oasis Tailwind CSS Admin Dashboard Template",
};
