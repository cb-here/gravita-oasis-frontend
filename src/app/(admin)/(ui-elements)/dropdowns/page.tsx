...
export const metadata: Metadata = {
  title: "Gravity Oasis Dropdowns | TailAdmin - Gravity Oasis Dashboard Template",
  description:
    "This is Gravity Oasis Dropdowns page for TailAdmin - Gravity Oasis Tailwind CSS Admin Dashboard Template",
  // other metadata
};
