...
export const metadata: Metadata = {
  title: "Gravity Oasis Progress | TailAdmin - Gravity Oasis Dashboard Template",
  description:
    "This is Gravity Oasis Progress page for TailAdmin - Gravity Oasis Tailwind CSS Admin Dashboard Template",
  // other metadata
};
