...
export const metadata: Metadata = {
  title: "Gravity Oasis FileManager Page | TailAdmin - Gravity Oasis Dashboard Template",
  description:
    "This is Gravity Oasis FileManager page for TailAdmin - Gravity Oasis Tailwind CSS Admin Dashboard Template",
  // other metadata
};
